...
.data
A: 	.word 	2, -3, 2, 5, -4	#khai bao mang
.text
main: 	la	$a0,A			#load dia chi mang A vao $a0
	li 	$a1,5			#load so phan tu cua mang A vao thanh ghi $a1
	j	mspfx			#nhay den chuong trinh con
	nop
continue:
lock:   j	lock			#vong lap vo han de ket thuc chuong trinh chinh
	nop
end_of_main:
#-----------------------------------------------------------------
#Procedure mspfx
